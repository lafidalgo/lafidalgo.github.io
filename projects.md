...
- **[Supermarket Products](supermarket-products)** - 🛒📷 Computer Vision project for a multinational company to detect and classify supermarket products. Implemented the solution using Google Cloud Platform (GCP) and Google Kubernetes Engine (GKE).
